...
import { Betta, BettaSchemaInput, WildBetta } from "../type/schema";
...
// Add new Data
bettaRoute.post("/", zValidator("json", BettaSchemaInput), async (c) => {
  const bettaJSON: Betta = await c.req.json();
